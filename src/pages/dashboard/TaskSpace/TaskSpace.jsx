  ...
  return (
    <section>
      <div className="hidden lg:block">
        <div className="grid grid-cols-3 w-11/12 pt-6 hover:pt-0 px-16 hover:px-0 opacity-60 hover:opacity-100 duration-700 ease-in-out mx-auto mt-4 lg:mt-10">
          {/* to do  */}
          <div className="scale-50 hover:scale-100 duration-700 ease-in-out">
            <h2 className="font-bold text-3xl text-gray-500 text-center uppercase mb-6">
              To Do
            </h2>
            <div className="border-2 border-gray-700 rounded-t-xl h-[390px] lg:h-[800px] overflow-y-scroll ">
              <div>
                {todoTasks?.map((task) => (
